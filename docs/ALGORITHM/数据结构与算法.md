...
function BinarySerachTree(){
    ...
    this.root = null 
    BinarySerachTree.prototype.insert = function (key){ // 插入数据
    ...
    BinarySerachTree.prototype.preOrderTraversal = function (handler){    // 先序遍历
        this.preOrderTraversalNode(this.root, handler)

    }
    BinarySerachTree.prototype.preOrderTraversalNode = function (node, handler){
        if(node  != null){
            handler(node.key)   // 处理我们经过的节点
            this.preOrderTraversalNode(node.left, handler)  // 处理经过的子节点
            this.preOrderTraversalNode(node.right, handler)  // 处理经过的子节点
        }
    }
    BinarySerachTree.prototype.midOrderTraversal = function (handler){    // 中序遍历
        this.midOrderTraversalNode(this.root, handler) 
    }
    BinarySerachTree.prototype.midOrderTraversalNode = function (node, handler){
        if(node  != null){ 
            this.midOrderTraversalNode(node.left, handler)  // 处理经过的子节点
            handler(node.key)   // 处理我们经过的节点
            this.midOrderTraversalNode(node.right, handler)  // 处理经过的子节点
        }
    }
}
